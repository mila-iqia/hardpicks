...
from hardpicks.analysis.fbp.publication.path_constants import pickles_directory, output_directory
...
table_output_path = output_directory.joinpath(
    "multiple_seeds_test_results.tex"
)
...
metrics_renaming_dictionary = {
    ...
    "test/RootMeanSquaredError": ("DEL3", "RMSE"),
    "test/MeanAbsoluteError": ("DEL4", "MAE"),
    "test/MeanBiasError": ("DEL5", "MBE"),
}
...
if __name__ == "__main__":
    if generate_pickle:
        ...
        results_df = get_test_results(mlflow_tracking_uri_template,
